    ...
    r.fn.paroller = function(i) {
        ...
        return this.each(function() {
            ...
            r(window).on("resize", function() {
                ...
                t = !0),
                "background" === m ? (e.background(l),
                "vertical" === b ? n.bgVertical(l, w) : "horizontal" === b && n.bgHorizontal(l, w)) : "foreground" === m && g <= f && (e.foreground(l),
                "vertical" === b ? n.vertical(l, z) : "horizontal" === b && n.horizontal(l, z))
            }),
            r(window).on("scroll", function() {
                ...
                t || (window.requestAnimationFrame(o),
                t = !0),
                "background" === m ? "vertical" === b ? n.bgVertical(l, w) : "horizontal" === b && n.bgHorizontal(l, w) : "foreground" === m && a <= f && ("vertical" === b ? n.vertical(l, z, p) : "horizontal" === b && n.horizontal(l, z, p))
            })
        })
    }
});
